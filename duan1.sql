...
-- Thời gian đã tạo: Th10 11, 2024 lúc 03:50 AM
...
CREATE TABLE `bill` (
  ...
  `bill_name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `bill_diachi` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `bill_sdt` int NOT NULL,
  `bill_email` varchar(225) COLLATE utf8mb4_general_ci NOT NULL,
  `id_pttt` int NOT NULL DEFAULT '1',
  `id_trangthai` int NOT NULL DEFAULT '1',
...
(141, 3, 'Điệp123111111', 'cầu giấy', 888888666, '111d@gmail.com', 1, 4, '2024-09-22', 16460000),
(142, 3, 'Điệp123111111', 'cầu giấy', 888888666, '111d@gmail.com', 1, 1, '2024-09-22', 0),
(143, 9, 'r3r3', 'feggrtew', 973658432, 'diep@gmail.com', 1, 1, '2024-11-11', 16770000);
...
CREATE TABLE `binhluan` (
  ...
  `id_user` int NOT NULL,
  `id_sp` varchar(11) COLLATE utf8mb4_general_ci NOT NULL,
...
(123, 3, '7', 'anh6.png', 'Laptop ASUS TUF GAMING FX506HF-HN014W', 16390000, 1, 141, 71),
(124, 9, '10', 'category-acer.jpg', 'Laptop Cũ Dell Precision 7520 - Intel Core i7', 16700000, 1, 143, 80);
...
CREATE TABLE `lienhe` (
  `id` int NOT NULL,
  `lh_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `lh_email` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `lh_sdt` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `lh_noidung` text COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(5, 'ádfg', 'diep123@fpt.edu.vn', '0123456789', 'xdfg');
...
CREATE TABLE `magiamgia` (
  `id` int NOT NULL,
  `name_magg` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `mausp` (
  `idmau` int NOT NULL,
  `mau` varchar(50) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `sanpham` (
  ...
  `tensp` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `img` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `gia` int NOT NULL,
...
(3, 'diep', '123456', 'diep95gmail.com', 'số 1 Trịnh Văn Bô', '0123456789', 1, 1),
(9, 'diepuser', '123456', 'diep123@gmail.com', '123 Nam từ liêm', '123456', 2, 1);
...
--
ALTER TABLE `binhluan`
  MODIFY `id_bl` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `mausp`
  MODIFY `idmau` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `sizesp`
  MODIFY `idsize` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `spbienthe`
--
ALTER TABLE `spbienthe`
  MODIFY `id_bt` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
...
--
ALTER TABLE `trangthaidh`
  MODIFY `idtrangthai` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
